...
let
    lat_GS = Latitude(51.9)
    lon_GS = Longitude(10.43)
    lat_SD = Latitude(32.82)
    lon_SD = Longitude(-117.10)
...
suite "sun position":
    ...
    test "sun position for Goslar @ 21 Dec 2018 9:00":
        check verifySunPosition(shortestDayMorningGS, lat_GS, lon_GS, 136.0, 3.3)
    test "sun position for Goslar @ 21 Dec 2018 18:00":
        check verifySunPosition(shortestDayEveningGS, lat_GS, lon_GS, 252.0, -15.8)
    test "sun position for San Diego @ 21 Dec 2018 9:00":
        check verifySunPosition(shortestDayMorningSD, lat_SD, lon_SD, 139.2, 21.2)
    test "sun position for San Diego @ 21 Dec 2018 18:00":
        check verifySunPosition(shortestDayEveningSD, lat_SD, lon_SD, 251.6, -15.1)
    
    # longest day
    test "sun position for Goslar @ 21 Jun 2019 9:00":
        check verifySunPosition(longestDayMorningGS, lat_GS, lon_GS, 94.1, 33.6)
    test "sun position for Goslar @ 21 Jun 2019 18:00":
        check verifySunPosition(longestDayEveningGS, lat_GS, lon_GS, 269.9, 30.5)
    test "sun position for San Diego @ 21 Jun 2019 9:00":
        check verifySunPosition(longestDayMorningSD, lat_SD, lon_SD, 85.0, 39.0)
    test "sun position for San Diego @ 21 Jun 2019 18:00":
        check verifySunPosition(longestDayEveningSD, lat_SD, lon_SD, 284.2, 22.6)

suite "sun times":
    # longest day
    test "sun times for Goslar @ 21 Jun 2019":
        let st = sunDateTimes(longestDayEveningGS, lat_GS, lon_GS, tzGSs)
    ...
    test "sun times for San Diego @ 21 Jun 2019":
        let st = sunDateTimes(longestDayEveningSD, lat_SD, lon_SD, tzSDs)
...
suite "moon position":
    ...
    test "moon position for Goslar @ 21 Dec 2018 9:00":
        check verifyMoonPosition(shortestDayMorningGS, lat_GS, lon_GS, 331.0, -15.3, 368681)
    test "moon position for Goslar @ 21 Dec 2018 18:00":
        check verifyMoonPosition(shortestDayEveningGS, lat_GS, lon_GS, 85.7, 20.7, 367007)
    test "moon position for San Diego @ 21 Dec 2018 9:00":
        check verifyMoonPosition(shortestDayMorningSD, lat_SD, lon_SD, 329.5, -31.8, 367007)
    test "moon position for San Diego @ 21 Dec 2018 18:00":
        check verifyMoonPosition(shortestDayEveningSD, lat_SD, lon_SD, 79.0, 20.9, 365512)

    # longest day
    test "moon position for Goslar @ 21 Jun 2019 9:00":
        check verifyMoonPosition(longestDayMorningGS, lat_GS, lon_GS, 240.2, -1.1, 402248)
    test "moon position for Goslar @ 21 Jun 2019 18:00":
        check verifyMoonPosition(longestDayEveningGS, lat_GS, lon_GS, 28.0, -53.2, 402989)
    test "moon position for San Diego @ 21 Jun 2019 9:00":
        check verifyMoonPosition(longestDayMorningSD, lat_SD, lon_SD, 244.0, 6.6, 402989)
    test "moon position for San Diego @ 21 Jun 2019 18:00":
        check verifyMoonPosition(longestDayEveningSD, lat_SD, lon_SD, 53.55, -65.4, 403598)
